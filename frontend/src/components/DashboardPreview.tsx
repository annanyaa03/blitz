    ...
    <section id="dashboard" className="w-full min-h-screen pt-32 pb-24 px-8 relative z-10 bg-background">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-10 pb-6 border-b border-border/40">
          <div className="flex items-center gap-2 bg-card p-1.5 rounded-none border border-border/60 shadow-sm flex-wrap">
            <button
              onClick={() => setTradingMode("selection")}
              className={`px-4 py-2 rounded-none text-xs md:text-sm font-medium transition-all flex items-center gap-2 cursor-pointer ${
                tradingMode === "selection"
                  ? "bg-foreground text-background shadow-md"
                  : "text-muted hover:text-foreground"
              }`}
            >
              <span className="flex items-center gap-2"><Layers size={14} className="text-[#836EF9]" /> Mode Selection</span>
            </button>
            <button
            ...
            >
              <span className="w-2 h-2 rounded-none bg-blue-500 md:hidden" />
              <span className="flex items-center gap-2"><Shield size={14} /> AI Copilot</span>
              <span className="hidden md:inline-block text-[10px] font-mono opacity-80 px-1.5 py-0.5 rounded-none bg-white/20">Manual</span>
            </button>
            <button
            ...
            >
              <span className="w-2 h-2 rounded-none bg-[#836EF9] md:hidden" />
              <span className="flex items-center gap-2"><Bot size={14} /> AI Autopilot</span>
              <span className="hidden md:inline-block text-[10px] font-mono opacity-80 px-1.5 py-0.5 rounded-none bg-white/20">Autonomous</span>
            </button>
          </div>

          <div className="hidden lg:flex items-center gap-4 text-xs text-muted font-mono bg-card/40 px-4 py-2 rounded-none border border-border/40">
        ...
        <AnimatePresence mode="wait">
          ...
          {tradingMode === "copilot" && (
            ...
            >
              ...
              <div className="mb-8 p-6 md:p-8 rounded-none bg-gradient-to-r from-blue-500/10 via-indigo-500/5 to-transparent border border-blue-500/30 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-xl shadow-blue-500/5">
                <div className="flex items-center gap-5">
                  <div className="w-14 h-14 rounded-none bg-blue-500/10 border border-blue-500/30 flex items-center justify-center text-blue-500 shrink-0 shadow-inner">
                    <UserCheck size={28} />
                  </div>
                  <div>
                    <div className="flex items-center gap-3 flex-wrap">
                      <h3 className="text-xl md:text-2xl font-light tracking-tight text-foreground">Manual Trading Workspace</h3>
                      <span className="text-xs font-mono bg-blue-500 text-white px-3 py-1 rounded-none font-medium shadow-sm flex items-center gap-1.5">
                ...
                <div className="flex items-center gap-3 self-stretch md:self-auto justify-end">
                  <button
                    onClick={() => setTradingMode("autopilot")}
                    className="px-5 py-2.5 rounded-none border border-border/80 bg-card hover:border-[#836EF9]/50 text-xs font-medium text-muted hover:text-foreground transition-all flex items-center gap-2 shadow-sm group cursor-pointer"
                  >
          ...
          {tradingMode === "autopilot" && (
            ...
            >
              ...
              <div className="mb-8 p-6 md:p-8 rounded-none bg-gradient-to-r from-[#836EF9]/10 via-purple-500/5 to-transparent border border-[#836EF9]/30 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-xl shadow-[#836EF9]/5">
                <div className="flex items-center gap-5">
                  <div className="w-14 h-14 rounded-none bg-[#836EF9]/10 border border-[#836EF9]/30 flex items-center justify-center text-[#836EF9] shrink-0 shadow-inner">
                    <Bot size={28} />
                  </div>
                  <div>
                    <div className="flex items-center gap-3 flex-wrap">
                      <h3 className="text-xl md:text-2xl font-light tracking-tight text-foreground">Autonomous Trading Workspace</h3>
                      <span className="text-xs font-mono bg-[#836EF9] text-white px-3 py-1 rounded-none font-medium shadow-sm flex items-center gap-1.5">
                ...
                <div className="flex items-center gap-3 self-stretch md:self-auto justify-end">
                  <button
                    onClick={() => setTradingMode("copilot")}
                    className="px-5 py-2.5 rounded-none border border-border/80 bg-card hover:border-blue-500/50 text-xs font-medium text-muted hover:text-foreground transition-all flex items-center gap-2 shadow-sm group cursor-pointer"
                  >
        ...
        {/* Shared Workspace Grid Layout (Only visible in Copilot or Autopilot mode) */}
        {tradingMode !== "selection" && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="lg:col-span-8 flex flex-col gap-8">
              ...
              {tradingMode === "autopilot" && (
                <div className="bg-foreground h-auto min-h-[300px] rounded-none overflow-hidden shadow-xl border border-border/20">
              ...
              {/* If in Copilot mode, AI Reasoning is here */}
              {tradingMode !== "autopilot" && (
